...
public abstract class CommonFluidRestrictionEntry<T extends CommonFluidRestrictionEntry<T, P, C>, P extends RestrictionEntry.PreCompiled<P, C>, C extends CompiledRestrictionEntry<C, P>> extends AbstractFluidRestrictionEntry<T, P, C> {
    public CommonFluidRestrictionEntry(PreparedRestrictionPredicate predicate, RestrictionEntryOrigin origin, FluidContentWrapper gameContent) {
        super(predicate, origin, gameContent);
    }

    @Override
    public FluidContentWrapper gameContent() {
        return (FluidContentWrapper) super.gameContent();
    }
}
