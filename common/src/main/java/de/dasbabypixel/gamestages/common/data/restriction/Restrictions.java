...
public class Restrictions {
    public static @NonNull CompositePreparedRestrictionPredicate and(@NonNull PreparedRestrictionPredicate @NonNull ... dependencies) {
        return And.INSTANCE.prepare(dependencies);
    }

    public static @NonNull CompositePreparedRestrictionPredicate or(@NonNull PreparedRestrictionPredicate @NonNull ... dependencies) {
